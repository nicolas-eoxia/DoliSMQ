...
class Question extends SaturneObject
{
    ...
    public $fields = [
        ...
        'type'                   => ['type' => 'select',       'label' => 'QuestionType',         'enabled' => 1, 'position' => 80,  'notnull' => 1, 'visible' => 1, 'arrayofkeyval' => ['OkKoToFixNonApplicable' => Question::TYPE_OK_KO_TOFIX_NA, 'OkKo' => Question::TYPE_OK_KO, 'UniqueChoice' => Question::TYPE_UNIQUE_CHOICE, 'MultipleChoices' => Question::TYPE_MULTIPLE_CHOICES, 'Text' => Question::TYPE_TEXT, 'Percentage' => Question::TYPE_PERCENTAGE, 'Range' => Question::TYPE_RANGE], 'default' => Question::TYPE_UNIQUE_CHOICE, 'css' => 'minwidth150', 'showoncombobox' => 1],
        ...
        'enter_comment'          => ['type' => 'boolean',      'label' => 'EnterComment',         'enabled' => 1, 'position' => 110, 'notnull' => 0, 'visible' => -1],
        'authorize_answer_photo' => ['type' => 'boolean',      'label' => 'AuthorizeAnswerPhoto', 'enabled' => 1, 'position' => 120, 'notnull' => 0, 'visible' => -1],
        'show_photo'             => ['type' => 'boolean',      'label' => 'ShowPhoto',            'enabled' => 1, 'position' => 130, 'notnull' => 0, 'visible' => -1],
        'photo_ok'               => ['type' => 'text',         'label' => 'PhotoOk',              'enabled' => 1, 'position' => 140, 'notnull' => 0, 'visible' => -1],
        'photo_ko'               => ['type' => 'text',         'label' => 'PhotoKo',              'enabled' => 1, 'position' => 150, 'notnull' => 0, 'visible' => -1],
        'json'                   => ['type' => 'text',         'label' => 'JSON',                 'enabled' => 1, 'position' => 160, 'notnull' => 0, 'visible' => -1, 'css' => 'tdoverflowmax200'],
