                ...
                <?php if ($question->show_photo > 0 && getDolGlobalInt('DIGIQUALI_' . dol_strtoupper($object->element) . '_DISPLAY_MEDIAS')) : ?>
                    <div class="question__header-medias">
                        <div class="question__photo-ref-ok">
                            ...
                            <?php print saturne_show_medias_linked('digiquali', $conf->digiquali->multidir_output[$conf->entity] . '/question/'. $question->ref . '/photo_ok', 'small', '', 0, 0, 0, 100, 100, 0, 0, 0, 'question/' . $question->ref . '/photo_ok', $question, 'photo_ok', 0, 0, 0,1, 'photo-ok', 0); ?>
                        </div>
                        <div class="question__photo-ref-ko">
                            <i class="question__photo-ref-icon fas fa-times"></i>
                            <?php print saturne_show_medias_linked('digiquali', $conf->digiquali->multidir_output[$conf->entity] . '/question/'. $question->ref . '/photo_ko', 'small', '', 0, 0, 0, 100, 100, 0, 0, 0, 'question/' . $question->ref . '/photo_ko', $question, 'photo_ko', 0, 0, 0,1, 'photo-ko', 0);  ?>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="question__container">
                    <div class="question__header">
                        <div class="question__header-content">
                            ...
                            <div class="question-points"><strong><?php echo $langs->trans('Scoring'); ?> : </strong><span class="score-value"><?php echo $question->formatSingleQuestionScore(-1, $questionAnswer ?? '') ?></span></div>
                        </div>
