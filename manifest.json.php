...
$manifest->short_name = getDolGlobalString('MAIN_INFO_SOCIETE_NOM') . '-DigiQuali';
$manifest->name       = getDolGlobalString('MAIN_INFO_SOCIETE_NOM') . '-DigiQuali';
$manifest->icons      = [];

$img               = new stdClass();
$img->src          = dol_buildpath('/custom/digiquali/img/digiquali_color.svg', 1);
$img->type         = 'image/svg+xml';
$img->sizes        = '150x150';
$manifest->icons[] = $img;

$img               = new stdClass();
$img->src          = dol_buildpath('/custom/digiquali/img/digiquali_color_192.png', 1);
$img->type         = 'image/png';
$img->sizes        = '192x192';
$manifest->icons[] = $img;
