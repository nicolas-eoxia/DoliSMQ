...
/**
 * \file    view/frontend/pwa_sheets.php
 * \ingroup digiquali
 * \brief   PWA mobile list of Sheets (models).
 */
...
if (empty($user->rights->digiquali->sheet->read)) {
    accessforbidden();
}

$title    = $langs->trans('Sheets');
...
llxHeader('', $title, $help_url, '', 0, 0, $moreJS, $moreCSS, '', 'template-pwa pwa-sheets-list');

$pwaHeaderCenterHtml = '<div class="pwa-header-indicator"><i class="fas fa-clipboard-list"></i> ' . ucfirst($langs->trans('Sheets')) . '</div>';
