...
/**
 * \file    view/frontend/pwa_surveys.php
 * \ingroup digiquali
 * \brief   PWA mobile list of Surveys (questionnaires).
 */
...
if (empty($user->rights->digiquali->survey->read)) {
    accessforbidden();
}
...
llxHeader('', $title, $help_url, '', 0, 0, $moreJS, $moreCSS, '', 'template-pwa pwa-surveys-list');

$pwaHeaderCenterHtml = '<div class="pwa-header-indicator"><i class="fas fa-list-ol"></i> ' . $langs->trans('Surveys') . '</div>';
